...
<h3> 문뜩 코딩을 하다가 가만히 있는 이미지를 보고 심심하다고 느껴졌습니다. 그러나 css의 애니메이션과 같은것을 공부하기에는 아직 저의 css 수준이 낮다고 생각이 들었습니다. 그래서 생각해낸 방법이 " 타입스크립트로 n초 마다 이미지를 바꾸면 어떨까?"입니다. 해당 방법을 setInterval()로 구현을 하였으나, setTimeout()으로도 구현이 가능하다고 생각이 들어 두 비동기 함수를 비교하고자 글을 작성하게 되었습니다.</h3>
